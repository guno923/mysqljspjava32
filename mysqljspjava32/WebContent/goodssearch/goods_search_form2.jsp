...
<form action="<%=request.getContextPath()%>/goodssearch/goods_search_list2.jsp" method="post">
<script>
$(function() {
...
<tr>
<tr>
<td><input type="radio" name="pricet" value="desc">높은 가격순 <input type="radio" name="pricet" value="asc">낮은 가격순</td>
<tr>
<tr>
