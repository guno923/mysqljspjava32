...
<%@ include file="/goodssearch/goods_search_form2.jsp" %>
...
try{
	...
	if(date1 == null & date2 == null) {
		...
		if(gprice1.equals("")& gprice2.equals("") & gname.equals("") & gpricet != null) {
			pstmt = conn.prepareStatement("select tb_member.*, tb_goods.* from tb_member inner join tb_goods on tb_member.m_id = tb_goods.m_id where g_date between ? and ? order by g_price*1 " + gpricet);
			pstmt.setString(1, date1);
			pstmt.setString(2, date2);
		} else if(gprice1 != null & gprice2 != null & gname.equals("") & gpricet != null){
			pstmt = conn.prepareStatement("select tb_member.*, tb_goods.* from tb_member inner join tb_goods on tb_member.m_id = tb_goods.m_id where  g_date between ? and ? and g_price*1 between ? and ? order by g_price*1 " + gpricet);
			...
			pstmt = conn.prepareStatement("select tb_member.*, tb_goods.* from tb_member inner join tb_goods on tb_member.m_id = tb_goods.m_id where  g_date between ? and ? and g_name= ? order by g_price*1 " + gpricet);
			pstmt.setString(1, gname);
			pstmt.setString(2, date1);
			pstmt.setString(3, date2);
		} else if(gprice1 != null & gprice2 != null & gname != null & gpricet != null) {
			pstmt = conn.prepareStatement("select tb_member.*, tb_goods.* from tb_member inner join tb_goods on tb_member.m_id = tb_goods.m_id where  g_date between ? and ? and g_name= ? and g_price*1 between ? and ? order by g_price*1 " + gpricet);
			int gprice11 = Integer.parseInt(gprice1);
			int gprice22 = Integer.parseInt(gprice2);
			pstmt.setString(1, gname);
			pstmt.setString(2, date1);
			...
			pstmt = conn.prepareStatement("select tb_member.*, tb_goods.* from tb_member inner join tb_goods on tb_member.m_id = tb_goods.m_id where g_date between ? and ?");
			pstmt.setString(1, date1);
			pstmt.setString(2, date2);
		} else if(gprice1.equals("") & gprice2.equals("") & gname != null) {
			pstmt = conn.prepareStatement("select tb_member.*, tb_goods.* from tb_member inner join tb_goods on tb_member.m_id = tb_goods.m_id where  g_date between ? and ? and g_name= ?");
			pstmt.setString(1, gname);
			pstmt.setString(2, date1);
			pstmt.setString(3, date2);
		} else if(gprice1 != null & gprice2 != null & gname.equals("")){
			pstmt = conn.prepareStatement("select tb_member.*, tb_goods.* from tb_member inner join tb_goods on tb_member.m_id = tb_goods.m_id where  g_date between ? and ? and g_price*1 between ? and ?");
			int gprice11 = Integer.parseInt(gprice1);
			int gprice22 = Integer.parseInt(gprice2);
			pstmt.setString(1, date1);
			pstmt.setString(2, date2);
			...
			pstmt = conn.prepareStatement("select tb_member.*, tb_goods.* from tb_member inner join tb_goods on tb_member.m_id = tb_goods.m_id where  g_date between ? and ? and g_name= ? and g_price*1 between ? and ?");
			int gprice11 = Integer.parseInt(gprice1);
			int gprice22 = Integer.parseInt(gprice2);
			pstmt.setString(1, gname);
			pstmt.setString(2, date1);
