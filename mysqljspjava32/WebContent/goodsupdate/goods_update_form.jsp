...
<%
	String send_ude=request.getParameter("g_code");
	System.out.println(send_ude + "<-send_de");
...
%>
<form action="<%= request.getContextPath() %>/goodsupdate/goods_update_pro.jsp" method="post">
<table border="1">
<tr>
	<td>판매자</td>
...
<tr>
	<td>카테고리</td>
	<td><input type="text" name="g_cate" size="20" value="<%= dbgcate %>"></td>
<tr>
<tr>
	<td>가격</td>
	<td><input type="text" name="g_price" size="20" value="<%= dbgprice %>"></td>
<tr>
<tr>
	<td>색상</td>
	<td><input type="text" name="g_color" size="20" value="<%= dbgcolor %>"></td>
<tr>
<tr>
	<td>사이즈</td>
	<td><input type="text" name="g_size" size="20" value="<%= dbgsize %>"></td>
<tr>
<tr>
	<td>등록날짜</td>
...
<tr>
	<td>상세설명</td>
	<td><input type="text" name="g_desc" size="20" value="<%= dbgdesc %>"></td>
<tr>
<tr>
